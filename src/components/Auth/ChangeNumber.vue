<template>
  <div>
    <md-steppers :md-active-step.sync="active" md-linear>
                ...
                <div class="md-layout-item md-small-size-100">
                  <md-field :class="getValidationClass('phone')">
                    ...
                    <md-input
                      ...
                      :disabled="sending"
                    />
                    <span class="md-error" v-if="!$v.form.phone.required">{{ $t("auth.validation.required", { msg: $t("auth.phone") }) }}</span>
      ...
      <md-step id="third" md-label="Done" :md-done.sync="third">
        <md-card>
          <md-card-content
