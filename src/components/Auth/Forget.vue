              ...
              <div class="md-layout md-gutter">
                <div class="md-layout-item md-small-size-100">
                  <md-field :class="getValidationClass('phone')">
                    ...
                    >{{ $t("auth.validation.required", { msg: $t("auth.phone") }) }}</span>
                    <span
                      class="md-error"
                      v-else-if="!$v.form.phone.rightPhone"
                    >{{ $t("auth.validation.rightPhone", { msg: $t("auth.phone") }) }}</span>
                    <span
                      class="md-error"
                      v-else-if="!$v.form.phone.numeric"
                    >{{ $t("auth.validation.numeric", { msg: $t("auth.phone") }) }}</span>
                  </md-field>
                </div>
              </div>
            </md-card-content>
          ...
          <md-card class="md-layout-item md-size-100 md-small-size-100">
            <md-card-content>
              ...
              <md-field :class="getValidationNewPasswordClass('repeatPassword')">
                <label for="repeatPassword">{{ $t("auth.confirm_passowrd")}}</label>
                <md-input
                  name="repeatPassword"
                  id="repeatPassword"
                ...
                >{{ $t("auth.validation.same_password") }}</span>
              </md-field>
            </md-card-content>
          </md-card>
